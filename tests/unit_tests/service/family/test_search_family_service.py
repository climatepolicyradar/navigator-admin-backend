...
admin_user_context = "test@cpr.org"
ORG_ID = 1
...
def test_search(family_repo_mock, app_user_repo_mock, admin_user_context):
...
def test_search_on_specific_field(
    family_repo_mock, app_user_repo_mock, admin_user_context
):
...
def test_search_db_error(family_repo_mock, app_user_repo_mock, admin_user_context):
...
def test_search_missing(family_repo_mock, app_user_repo_mock, admin_user_context):
