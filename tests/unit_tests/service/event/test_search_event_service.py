...
def test_search(event_repo_mock, app_user_repo_mock, admin_user_context):
...
def test_search_db_error(event_repo_mock, app_user_repo_mock, admin_user_context):
...
def test_search_missing(event_repo_mock, app_user_repo_mock, admin_user_context):
