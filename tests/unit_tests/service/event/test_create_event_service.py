...
def test_create(event_repo_mock, family_repo_mock, admin_user_context):
...
def test_create_when_db_fails(event_repo_mock, family_repo_mock, admin_user_context):
    new_event = create_event_create_dto()
...
def test_create_success_when_org_mismatch(
    event_repo_mock, family_repo_mock, super_user_context
):
    new_event = create_event_create_dto()
